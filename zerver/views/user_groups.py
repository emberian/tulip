...
def edit_user_group(
    ...
    *,
    ...
    if color is not None and color != user_group.color:
        ...
        assert validated_color is not None  # color was not None, so validated_color won't be None
        do_update_user_group_color(user_group, validated_color, acting_user=user_profile)
